...
class User private constructor(
    ...
    fun checkPassword(pass: String) = encrypt(pass) == passwordHash.also {
        println("Checking passwordHash us $passwordHash")
    }
    ...
    fun changePassword(oldPass: String, newPass: String) {
        ...
        } else throw IllegalArgumentException("The entered password does not match to old password")
    }
    ...
    private fun encrypt(password: String): String {
        ...
        println("Salt while enctypt: $salt")
